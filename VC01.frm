...
SDel = "Delete * From VC01 where Kode = '" + Trim(KB) + "'"
...
SQLTiket = "Select * from VC01 where Kode = '" + Trim(Text1) + "'"
...
With grid
    ...
    .Col = 2: .ColWidth(2) = 1500: .Text = "SATUAN": .CellAlignment = 4
    .Col = 3: .ColWidth(3) = 1500: .Text = "H. JUAL": .CellAlignment = 4
End With
End Sub
   ...
   Do Until RCari.EOF
      ...
      grid.Row = B
         With grid
              ...
              .Col = 2: .Text = Format(RCari("Satuan"), "##,###.00")
              .Col = 3: .Text = Format(RCari("Jual"), "##,###.00")
         End With
      B = B + 1
      RCari.MoveNext
   Loop
...
Private Sub IsiText()
SCari2 = "Select * From VC01 where Kode = '" + Trim(KB) + "'"
Set RCari2 = RDCO.OpenResultset(SCari2, rdOpenDynamic, rdConcurRowVer)
If RCari2.RowCount <> 0 Then
    Text1 = RCari2("Kode")
    Text2 = RCari2("Nama")
    Text3 = Format(RCari2("Satuan"), "##,###.00")
    Text4 = Format(RCari2("Jual"), "##,###.00")
End If
RCari2.Close
Set RCari2 = Nothing
End Sub
...
SCari = "Select * From VC01 where Kode = '" + Trim(Text1) + "'"
Set RCari = RDCO.OpenResultset(SCari, rdOpenDynamic, rdConcurRowVer)
    If RCari.RowCount <> 0 Then
        MsgBox " KODE SUDAH TERDAFTAR", vbCritical, "KONFIRMASI"
        Text1 = ""
        Text1.SetFocus
    Else
       Text2.SetFocus
