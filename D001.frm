...
Begin VB.Form D001 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   308
      OleObjectBlob   =   "D001.frx":0000
      Top             =   6413
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   225
      Left            =   255
      OleObjectBlob   =   "D001.frx":0234
      TabIndex        =   8
      Top             =   113
      Width           =   930
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
      Height          =   225
      Left            =   255
      OleObjectBlob   =   "D001.frx":03D6
      TabIndex        =   13
      Top             =   1380
      Width           =   1140
   End
End
Attribute VB_Name = "D001"
...
SDel = "Delete * From D001 where Kode = '" + Trim(Text1) + "'"
...
If Text1 = "" Or Text2 = "" Or Text3 = "" Or Text4 = "" Or Text5 = "" Then
    ...
    Text1.SetFocus
Else
    SSave = "Select * From D001 where Kode = '" + Trim(KB) + "'"
...
Private Sub IsiText()
SCari2 = "Select * From D001 where Kode = '" + Trim(KB) + "'"
